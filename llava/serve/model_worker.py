...
from llava.mm_utils import process_images, load_image_from_base64, tokenizer_image_token, tokenizer_hybrid_token
    ...
    def generate_stream(self, params):
        ...
        if images is not None and len(images) > 0 and self.is_multimodal:
            if len(images) > 0:
                ...
                images = None
                image_sizes = None
            image_args = {"images": images, "image_sizes": image_sizes, "deepfake_inputs": images}
        else:
            images = None
            image_args = {}
        ...
        input_ids = tokenizer_hybrid_token(prompt, tokenizer, IMAGE_TOKEN_INDEX, DEEPFAKE_TOKEN_INDEX, return_tensors='pt').unsqueeze(0).to(self.device)
        keywords = [stop_str]
